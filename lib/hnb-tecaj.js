...
class CurrencyItem {
  ...
  calculateCurrencyAmount(domesticAmount) {
    ...
    var result = new CurrencyRateItem();
    result.BuyingRate = roundOnTwoDecimals((domesticAmount / this.Unit) / this.Rate.BuyingRate);
    result.MiddleRate = roundOnTwoDecimals((domesticAmount / this.Unit) / this.Rate.MiddleRate);
    result.SellingRate = roundOnTwoDecimals((domesticAmount / this.Unit) / this.Rate.SellingRate);
    return result;
  }
